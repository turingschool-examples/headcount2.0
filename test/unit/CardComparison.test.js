...
test('CardComparison component should render an instance of ComparisonCard', () => {
...
test('should render correct information on instance of ComparisonCard component', () => {
...
test('should render with correct className, index 0 blue-border, index 1 green-border', () => {
