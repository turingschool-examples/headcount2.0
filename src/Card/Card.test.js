...
describe('Card', () => {
  let card, stats, selectedLocations;
  ...
  it('has a class of selected matches in selectedLocations array', () => {
    selectedLocations = [];
    card = shallow(<Card 
      location="COLORADO"
      stats={stats} 
  ...
  it('When the article is clicked it calls selectedLocations function', ()=> {
