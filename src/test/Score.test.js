...
describe('Score', ()=>{
  ...
  it('should manipulate icon and alt based on lower values in props', () => {
    expect(wrapper.props().children.props.children[0].props.src).
      toEqual('./drop-down-arrow.svg');
    expect(wrapper.props().children.props.children[0].props.alt).
      toEqual('down');
  });
